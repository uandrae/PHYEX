...
IF(BUCONF%LBUDGET_TH) CALL TBUDGETS(NBUDGET_TH)%PTR%INIT_PHY(D, TRIM(HBUNAME), ZWKBUD)
IF(BUCONF%LBUDGET_RV) ZWKBUD(:, :) = PRVS(:, :)*PRHODJ(:, :)
IF(BUCONF%LBUDGET_RV) CALL TBUDGETS(NBUDGET_RV)%PTR%INIT_PHY(D, TRIM(HBUNAME), ZWKBUD)
IF(BUCONF%LBUDGET_RC) ZWKBUD(:, :) = PRCS(:, :)*PRHODJ(:, :)
...
!
IF(BUCONF%LBUDGET_TH) ZWKBUD(:, :) = PTHS(:, :)*PRHODJ(:, :)
IF(BUCONF%LBUDGET_TH) CALL TBUDGETS(NBUDGET_TH)%PTR%END_PHY(D, TRIM(HBUNAME), ZWKBUD)
IF(BUCONF%LBUDGET_RV) ZWKBUD(:, :) = PRVS(:, :)*PRHODJ(:, :)
IF(BUCONF%LBUDGET_RV) CALL TBUDGETS(NBUDGET_RV)%PTR%END_PHY(D, TRIM(HBUNAME), ZWKBUD)
IF(BUCONF%LBUDGET_RC) ZWKBUD(:, :) = PRCS(:, :)*PRHODJ(:, :)
IF(BUCONF%LBUDGET_RC) CALL TBUDGETS(NBUDGET_RC)%PTR%END_PHY(D, TRIM(HBUNAME), ZWKBUD)
IF(BUCONF%LBUDGET_RI) ZWKBUD(:, :) = PRIS(:, :)*PRHODJ(:, :)
IF(BUCONF%LBUDGET_RI) CALL TBUDGETS(NBUDGET_RI)%PTR%END_PHY(D, TRIM(HBUNAME), ZWKBUD)
!------------------------------------------------------------------------------
!
!

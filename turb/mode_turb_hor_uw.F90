...
CALL LES_MEAN_SUBGRID_PHY(D, TLES, ZMZF3D_WORK1, TLES%X_LES_SUBGRID_WU , .TRUE. )  
CALL GZ_U_UW_PHY(D, PUM,PDZZ, ZGZ_U_UW3D_WORK1)
...
!
CALL MZF_PHY(D, ZSHUGRADWK1_3D, ZMZF3D_WORK1)
CALL LES_MEAN_SUBGRID_PHY(D, TLES, ZMZF3D_WORK1, TLES%X_LES_RES_ddxa_U_SBG_UaU , .TRUE.)  
...
!
CALL MZF_PHY(D, ZSHUGRADWK1_3D, ZMZF3D_WORK1)
CALL LES_MEAN_SUBGRID_PHY(D, TLES, ZMZF3D_WORK1, TLES%X_LES_RES_ddxa_W_SBG_UaW , .TRUE.)  
...
CALL LES_MEAN_SUBGRID_PHY(D, TLES, ZMXF3D_WORK1,&

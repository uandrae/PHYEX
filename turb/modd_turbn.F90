...
INTEGER, POINTER :: ZCTP=>NULL()
INTEGER, POINTER :: ZCTV=>NULL()
INTEGER, POINTER :: ZCSHF=>NULL()
INTEGER, POINTER :: ZCEP=>NULL()
INTEGER, POINTER :: ZCED=>NULL()
INTEGER, POINTER :: ZCMFS=>NULL()
INTEGER, POINTER :: ZBL89EXP=>NULL()
INTEGER, POINTER :: ZUSRBL89=>NULL()
INTEGER, POINTER :: ZTURB_S=>NULL()
...
ZCTP=>TURB_MODEL(KTO)%ZCTP
ZCTV=>TURB_MODEL(KTO)%ZCTV
ZCSHF=>TURB_MODEL(KTO)%ZCSHF
ZCEP=>TURB_MODEL(KTO)%ZCEP
ZCED=>TURB_MODEL(KTO)%ZCED
ZCMFS=>TURB_MODEL(KTO)%ZCMFS
ZBL89EXP=>TURB_MODEL(KTO)%ZBL89EXP
ZUSRBL89=>TURB_MODEL(KTO)%ZUSRBL89
ZTURB_S=>TURB_MODEL(KTO)%ZTURB_S

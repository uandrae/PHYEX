...
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZMXF3D_WORK1, TLES%X_LES_SUBGRID_UThl )   
...
DO JK=1, IKT
  DO JJ=1, IJT
    DO JI=1, IIT
      ZWKLES(JI, JJ, JK) = ZMZF3D_WORK1(JI, JJ, JK)  
    END DO
  END DO
END DO

!
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZWKLES, TLES%X_LES_RES_ddxa_W_SBG_UaThl , .TRUE. )
...
DO JK=1, IKT
  DO JJ=1, IJT
    DO JI=1, IIT
      ZWKLES(JI, JJ, JK) = ZGX_M_M3D_WORK1(JI, JJ, JK)*ZMXF3D_WORK1(JI, JJ, JK)  
    END DO
  END DO
END DO

!
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZWKLES, TLES%X_LES_RES_ddxa_Thl_SBG_UaThl , .TRUE. )
  IF (KRR>=1) THEN
...
!
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZWKLES, TLES%X_LES_RES_ddxa_Rt_SBG_UaThl , .TRUE. )
  END IF
...
END IF
  ...
  IF (KSPLT==1 .AND. TLES%LLES_CALL) THEN
    CALL SECOND_MNH(ZTIME1)
    CALL MXF_PHY(D, ZFLX, ZMXF3D_WORK1)
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZMXF3D_WORK1, TLES%X_LES_SUBGRID_URt )     
CALL GX_W_UW_PHY(D, OFLAT, PWM,PDXX,PDZZ,PDZX, ZGX_W_UW3D_WORK1)
CALL MZM_PHY(D, ZFLX, ZMZM3D_WORK1)
...
!
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZWKLES, TLES%X_LES_RES_ddxa_W_SBG_UaRt , .TRUE. )
    CALL GX_M_M_PHY(D, OFLAT,PTHLM,PDXX,PDZZ,PDZX, ZGX_M_M3D_WORK1)
CALL MXF_PHY(D, ZFLX, ZMXF3D_WORK1)
...
!
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZWKLES, TLES%X_LES_RES_ddxa_Thl_SBG_UaRt , .TRUE. )
    CALL GX_M_M_PHY(D, OFLAT,PRM(:,:,:,1),PDXX,PDZZ,PDZX, ZGX_M_M3D_WORK1)
CALL MXF_PHY(D, ZFLX, ZMXF3D_WORK1)
...
!
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZWKLES, TLES%X_LES_RES_ddxa_Rt_SBG_UaRt , .TRUE. )
    CALL SECOND_MNH(ZTIME2)
    TLES%XTIME_LES = TLES%XTIME_LES + ZTIME2 - ZTIME1
  END IF
!
...
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZMXF3D_WORK1, TLES%X_LES_SUBGRID_URc )    
CALL SECOND_MNH(ZTIME2)
    TLES%XTIME_LES = TLES%XTIME_LES + ZTIME2 - ZTIME1
  END IF
!
...
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZMYF3D_WORK1, TLES%X_LES_SUBGRID_VThl )   
...
DO JK=1, IKT
  DO JJ=1, IJT
    DO JI=1, IIT
      ZWKLES(JI, JJ, JK) = ZGY_M_M3D_WORK1(JI, JJ, JK)*ZMYF3D_WORK1(JI, JJ, JK)  
    END DO
  END DO
END DO
...
END IF
  ...
  IF (KSPLT==1 .AND. TLES%LLES_CALL) THEN
    CALL SECOND_MNH(ZTIME1)
    CALL MYF_PHY(D, ZFLX, ZMYF3D_WORK1)
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZMYF3D_WORK1, TLES%X_LES_SUBGRID_VRt )     
CALL GY_W_VW_PHY(D, OFLAT, PWM,PDYY,PDZZ,PDZY, ZGY_W_VW3D_WORK1)
CALL MZM_PHY(D, ZFLX, ZMZM3D_WORK1)
...
CALL LES_MEAN_SUBGRID_PHY(D, TLES,ZMYF3D_WORK1, TLES%X_LES_SUBGRID_VRc )    
CALL SECOND_MNH(ZTIME2)
    TLES%XTIME_LES = TLES%XTIME_LES + ZTIME2 - ZTIME1
  END IF
  !

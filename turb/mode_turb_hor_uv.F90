...
USE MODI_GRADIENT_V, ONLY:GX_V_UV_DEVICE
USE MODI_GRADIENT_U, ONLY:GY_U_UV_DEVICE
...
CALL LES_MEAN_SUBGRID_PHY(D, TLES, ZMXF3D_WORK1, TLES%X_LES_SUBGRID_UV )   
CALL GY_U_UV_DEVICE(PUM,PDYY,PDZZ,PDZY, ZGY_U_UV3D_WORK1)
...
!
CALL MXF_PHY(D, ZSHUGRADWK1_3D, ZMXF3D_WORK1)
CALL LES_MEAN_SUBGRID_PHY(D, TLES, ZMXF3D_WORK1, TLES%X_LES_RES_ddxa_U_SBG_UaU , .TRUE.)  
CALL GX_V_UV_DEVICE(PVM,PDXX,PDZZ,PDZX, ZGX_V_UV3D_WORK1)
...
!
CALL MXF_PHY(D, ZSHUGRADWK1_3D, ZMXF3D_WORK1)
CALL LES_MEAN_SUBGRID_PHY(D, TLES, ZMXF3D_WORK1, TLES%X_LES_RES_ddxa_V_SBG_UaV , .TRUE.)  
